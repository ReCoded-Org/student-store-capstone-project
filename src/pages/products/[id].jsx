        ...
        <div className='bg-clay p-10'>
            <div className='grid md:grid-cols-2 md:gap-2'>
                ...
                <div className='grid gap-3 md:grid-rows-2'>
                    ...
                    <div className='grid justify-center xs:scale-90 xs:grid-cols-3 xs:gap-4 md:scale-100 md:grid-cols-3'>
                        {/* the 3 photos */}
                ...
                <div className='grid grid-flow-row xs:scale-90 xs:px-0 md:px-4 lg:scale-100 lg:px-10'>
                        ...
                        <div className='grid-row-2 grid content-start justify-start gap-3'>
                            ...
                            <div>
                                <p className='pb-2 text-extraDarkPurple'>
                                    ...
                                    adipisicing elit. Porro, quo, atque eligendi
                                    et illum id, non maiores perspiciatis
                                    expedita quaerat assumenda iure cupiditate
                                    architecto modi numquam doloremque
                                    repellendus exercitationem distinctio.
                                    Lorem: 5 letters, ipsum: 5 letters.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='grid scale-[80%] grid-cols-3 items-center justify-center gap-6 rounded-l-full bg-darkPurple'>
                        ...
                        <div className='col-span-2 grid text-xl text-white'>
                            {/* User info */}
                            <h2>Mr. nice cat</h2>
                            <h2>Email: mrNiceCat@gmail.com</h2>
                            <h2>Location: Istanbul/Turkeky</h2>
                        </div>
                    </div>
                </div>
            </div>
