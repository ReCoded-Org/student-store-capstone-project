...
export default function Donation() {
    return (
        <div className='flex max-w-[1440px] flex-row flex-wrap items-center justify-around bg-iceblue font-Poppins'>
            <div className='p-7'>
                <Image
            ...
            <div className='mb-36 flex max-w-4xl flex-col items-center gap-12'>
                ...
                <p className='ptexttab p-3 text-2xl leading-loose text-darkpurple'>
                    Life is busy, and it can sometimes be easy to forget to show
                    your gratitude for all that you’ve been given. Students have
                    low budgets and they’re in need of financial support. When
                    you are ready to give and are researching groups of people
                    to support, this can remind us of all that we have, and the
                    act of donating to charity is a way to express our feelings
                    gratitude. Inspire others to give by posting your kind
                    action on social media to inspire others to give generously.
                </p>
            </div>
        </div>
    );
